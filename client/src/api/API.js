...
// utility to process HTTP responses generated by the browser's fetch API
async function handle(res) {
  if (!res.ok) {
    let msg = "Request failed";
    try { msg = (await res.json()).error || msg; } catch { /* ignore : if the seerver sent back plain HTML */ }
    throw new Error(msg);
  }
